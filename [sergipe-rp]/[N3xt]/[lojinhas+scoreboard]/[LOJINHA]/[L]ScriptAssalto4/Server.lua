...
local Marker_Assalto1 = createMarker(1850.873, -1849.947, 13.654 -1, "cylinder", 1.2, 255, 0, 255, 0)
...
function Iniciar_Assalto1 (source)
	...
	if isElementWithinMarker(source, Marker_Assalto1) then
        ...
        if getElementData(source, "Zeed_Loja_Assaltada4") then
		...
		setElementData(source, "Zeed_Assaltando4", true)
		...
		setTimer(function()
    		...
    		setElementData(source, "Zeed_Assaltando4", false)
    		setElementData(source, "Zeed_Loja_Assaltada4", true)
...
function Loja_Assaltada (source)
	...
	setElementVisibleTo(Blip_Assaltada, root, true)
        triggerClientEvent(root, "N3xT.dxNotification", root, "[ATENÇÃO] o jogador '"..getPlayerName(source).."' esta saqueando a Lojinha proximo a oficina de Tunagem, em Los Santos.", "info")
        setTimer(function()
        setElementVisibleTo(Blip_Loja, root, true)
        setElementVisibleTo(Blip_Assaltada, root, false)
        setElementData(source, "Zeed_Loja_Assaltada4", false)
