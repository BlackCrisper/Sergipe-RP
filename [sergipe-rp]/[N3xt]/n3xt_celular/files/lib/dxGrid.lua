--[[************************************************************************]]
local font = dxCreateFont("files/font/Medium.ttf", 10)
local font2 = dxCreateFont("files/font/Bold.ttf", 10)
--[[*************************************************************************
*
*	PROJECT:		dxGridWlistsw
        ...
        if #dxGridW.items > 0 then
            ...
            for index, data in ipairs ( dxGridW.items ) do
                ...
                if data.vis then
                    ...
                    dxDrawRectangle ( data.x, data.y, data.w, data.h, tocolor ( 0, 0, 0, 70 ), data.pg );
                    ...
                    if data.se and data.se <= data.r and data.se >= seeFrom and data.se <= seeTo then
                        ...
                        dxDrawRectangle ( data.x, ( 30 % data.h ) + y2, data.w, 27, tocolor ( 0, 255, 127, 100 ), data.pg );
                    end
