...
login.label_password = guiCreateLabel(290, 100, 100, 20, "SENHA", false, login.back_ground)
...
login.label_first = guiCreateLabel(340, 260, 200, 20, "Primeira vez no servidor?", false, login.back_ground)
...
login.button_reg = guiCreateLabel(375, 310, 100, 20, "Registre-se", false, login.back_ground)
...
login.label_chek = guiCreateLabel(310, 170, 200, 20, "Salvar Login", false, login.back_ground)
