...
function dxClickElement(button, state, cx, cy)
	...
	if (button == "left") and (state == "down") then
		...
		for id, element in ipairs(getElementsByType("TS:EditBoxPresidioBR")) do
			if (getElementData(element, "mouseState") == "hovered") then
				editBoxId = id
		...
		if (editBoxId) then
			if (isElement(getElementsByType("TS:EditBoxPresidioBR")[editBoxId])) then
				if (getElementData(getElementsByType("TS:EditBoxPresidioBR")[editBoxId], "state") == false) then
					guiSetInputMode("no_binds")
					setElementData(getElementsByType("TS:EditBoxPresidioBR")[editBoxId], "state", true)
				end
			end
		end
	end
...
function dxCharacterElement(button)
	...
	for _, element in ipairs(getElementsByType("TS:EditBoxPresidioBR")) do
		if (getElementData(element, "state") == true) then
