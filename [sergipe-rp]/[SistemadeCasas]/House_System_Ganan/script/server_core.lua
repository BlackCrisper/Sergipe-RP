...
-- ==========     CARREGANDO E SINCRONIZANDO MARCADORES     ==========
...
-- ==========     VERIFICAÇÕES PARA ABRIR O PAINEL DE JOGADORES    ==========
...
-- ==========    TRANSFERÊNCIA DE INFORMAÇÕES DE CONTA     ==========
...
function outputChatOK(text, player)
	--outputChatBox("[Gestão da casa] #33FF24"..text, player, 56,120,172, true)
	exports.YM_DxMessages:addBox(player, ""..text.."", "info")
end
function outputChatBad(text, player)
	--outputChatBox("[Gestão da casa] #FF3324"..text, player, 56,120,172, true)
	exports.YM_DxMessages:addBox(player, ""..text.."", "info")
end

-- ==========     Obtendo o número de vagas de estacionamento     ==========
...
-- ==========     Obtenção do número de casas e apartamentos comprados     ==========
...
--	==========     Verificar se o recurso está em execução     ==========
...
function wipeAccount(accName)
	...
	outputDebugString(string.format("[HOUSE] Equivalente à conta %s: %i", accName, moneyEquivalent))
	return moneyEquivalent, data
end


-- ==========     Para compilar uma tabela de interiores     ==========
