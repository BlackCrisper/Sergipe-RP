...
function onDeleteHouse(ID)
	...
	exports.YM_DxMessages:addBox(client, "Você excluiu com sucesso uma casa com ID = "..ID.."", "success")
...
function sendToBighpanel(mrkData)
	...
	if isResourceRunning("house_apartments") then
		...
		exports.YM_DxMessages:addBox(client, "house_apartments não foi iniciado", "info")
